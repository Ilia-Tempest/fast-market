...
$mail->addAddress('info@fast2market.io');     // Кому будет уходить письмо 
$mail->addAddress('voronova@fast2market.io');     // Кому будет уходить письмо
...
$mail->Subject = 'Заявка с сайта "FAST2MARKET"';
